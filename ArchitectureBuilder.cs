...
public sealed partial class ArchitectureBuilder
{
    ...
    private void CreateServiceFiles(string modelName, Type forCreation, Type? viewModel)
    {
        ...
        content = File.ReadAllText(mapperPath)[..^4];
    ...
    private void AddRepositoryToUnitOfWork(string modelName)
    {
        ...
        repos = new string(repos.Take(repos.Length - 27).ToArray()) +
    ...
    Task SaveChangesAsync();
        ...
        a.Insert(10, "    public IGenericRepository<^&&^> ^&&^s { get; }\n".Replace("^&&^", modelName));
        a.Insert(a.Count - 7, $"        {modelName}s = new GenericRepository<{modelName}>(dbContext);");
    ...
    public string?[] GetOtherProjectNames()
    {
    ...
    private string GetSolutionPath()
    {
        ...
        while (currentDirPath != null)
        {
            ...
            var solutionFileName =
                fileInCurrentDir.SingleOrDefault(f => f.EndsWith(".sln", StringComparison.InvariantCultureIgnoreCase));
